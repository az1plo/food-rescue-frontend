...
@Component({
  selector: 'app-workspace-analytics-redirect',
  template: '',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WorkspaceAnalyticsRedirectPage {
      ...
      .subscribe({
        next: (businesses) => {
          ...
          if (targetBusinessId) {
            ...
            void this.router.navigate(['/workspace', 'my-businesses', targetBusinessId, 'analytics'], {
              replaceUrl: true,
            });
            return;
          }
