...
@Component({
  selector: 'app-workspace-settings-redirect',
  template: '',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WorkspaceSettingsRedirectPage {
      ...
      .subscribe({
        next: (businesses) => {
          ...
          if (targetBusinessId) {
            ...
            void this.router.navigate(['/workspace', 'my-businesses', targetBusinessId, 'settings'], {
              replaceUrl: true,
            });
            return;
          }
